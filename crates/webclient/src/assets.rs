...
pub fn svg_filter_icon<MSG>(w: i32, h: i32) -> Node<MSG>
where
    MSG: Clone,
{
...
pub fn sort_btn_asc<MSG>(w: i32, h: i32) -> Node<MSG>
where
    MSG: Clone,
{
    svg([ version("1.1"), width(px(w)), height(px(h)), viewBox([0, 0, 512, 512,]), enable_background("new 0 0 512 512")],
    [polygon([points("256.5,64.5 64.5,256.5 176.5,256.5 176.5,448.5 336.5,448.5 336.5,256.5 448.5,256.5"), fill("rgb(128,128,128)")], []) ])
}
