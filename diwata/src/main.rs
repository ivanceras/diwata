...
struct Opt {
    ...
    db_url: String,
    #[structopt(short = "a", long = "address", help = "The address the server would listen, default is 0.0.0.0")]
    address: Option<String>,
    #[structopt(short = "p", long = "port", help = "What port this server would listen to, default is 8000")]
    port: Option<u16>,
}
